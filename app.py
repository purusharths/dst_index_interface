...
def index():
    ...
    if year and month:
        if int(year) > 1957 and int(year) < 2014:# and 
            if int(month)>1 and int(month)<13:
                ...
                if day:
                    ...
                    if int(day) > limit:
                        return render_template("error.html", error_message="Invalid day specified for the given month/year. Please Try again")
                ...
                return render_template("error.html", error_message="Invalid Month. Please try again.")
        else:
            return render_template("error.html", error_message="Year outside the specified Scope. Please try again.")
    else:
